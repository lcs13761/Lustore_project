        ...
        <div style="padding-top:30px;">
            ...
            <form style="padding-top: 10px" action="{{ url('/reset-password') }}" method="post">
                ...
                <div class="position_relative">
                    ...
                    <span onClick="inputPasswordActions('password','hiddenPassword','showPassword')" id = "showPassword" class="showPasswordPosition">
                        <x-heroicon-o-eye class="iconSize" />
                    </span>
                    <span onClick="inputPasswordActions('password','showPassword','hiddenPassword')"  style = "display:none;" onClick="" id = "hiddenPassword" class="showPasswordPosition">
                        <x-tni-eye-closed-o class="iconSize" />
                    </span>
                </div>
                <div class = "position_relative">
                    ...
                    <span onClick="inputPasswordActions('password_confirmation','hiddenPassword_re','showPassword_re')"  id = "showPassword_re" class="showPasswordPosition">
                        <x-heroicon-o-eye class="iconSize" />
                    </span>
                     <span style = "display:none;" id = "hiddenPassword_re" onClick="inputPasswordActions('password_confirmation','showPassword_re','hiddenPassword_re')"  class="showPasswordPosition">
                        <x-tni-eye-closed-o class="iconSize" />
                    </span>
                </div>
                <div>
